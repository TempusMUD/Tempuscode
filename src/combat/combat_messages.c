            ...
            int w_type, int location)
{
    ...
    static struct dam_weapon_type {
        ...
        {                       // 0: 0
            ...
            "$n massacres $N to small fragments with $s #w.", "You massacre $N to small fragments with your #w.", "$n massacres you to small fragments with $s #w."
        }, {                                                                                                                                                        // 8: 23 - 32
            "$n devastates $N with $s incredible #w!!", "You devastate $N with your incredible #w!!", "$n devastates you with $s incredible #w!!"
        }, {                                                                                                                                        // 9: 32 - 37
            "$n OBLITERATES $N with $s deadly #w!!", "You OBLITERATE $N with your deadly #w!!", "$n OBLITERATES you with $s deadly #w!!"
        }, {                                                                                                                                // 10: 37 - 45
            "$n utterly DEMOLISHES $N with $s unbelievable #w!!", "You utterly DEMOLISH $N with your unbelievable #w!!", "$n utterly DEMOLISHES you with $s unbelievable #w!!"
        }, {                                                                                                                                                                    // 11: 46 - 69
            "$n PULVERIZES $N with $s vicious #w!!", "You PULVERIZE $N with your vicious #w!!", "$n PULVERIZES you with $s vicious #w!!"
        }, {                                                                                                                                // 12: 70 - 99
            "$n *DECIMATES* $N with $s horrible #w!!", "You *DECIMATE* $N with your horrible #w!!", "$n *DECIMATES* you with $s horrible #w!!"
        }, {                                                                                                                                    // 13: 100 - 139
            "$n *LIQUEFIES* $N with $s incredibly vicious #w!!", "You **LIQUEFY** $N with your incredibly vicious #w!!", "$n *LIQUEFIES* you with $s incredibly vicious #w!!"
        }, {                                                                                                                                                                    // 14: 140 - 189
            "$n **VAPORIZES** $N with $s terrible #w!!", "You **VAPORIZE** $N with your terrible #w!!", "$n **VAPORIZES** you with $s terrible #w!!"
        }, {                                                                                                                                            // 15: >189
