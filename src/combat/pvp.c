...
check_attack(struct creature *attacker, struct creature *victim)
{
    ...
    send_to_char(perp, "%sYou have gained %d reputation for attacking %s.%s",
                 CCRED(perp, C_NRM), gain, GET_NAME(victim), CCNRM(perp, C_NRM));
    send_to_char(victim, "%s%s has gained %d reputation for attacking you.%s",
...
count_pkill(struct creature *killer, struct creature *victim)
{
    ...
    send_to_char(perp, "%sYou have gained %d reputation for murdering %s.%s",
                 CCRED(killer, C_NRM), gain, GET_NAME(victim), CCNRM(perp, C_NRM));
    send_to_char(victim, "%s%s has gained %d reputation for murdering you.%s",
