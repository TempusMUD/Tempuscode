...
#define NUM_OF_BOARDS	        52	/* change if needed! */
...
int	Board_remove_msg(int board_type, struct char_data *ch, struct obj_data *obj, char *arg);
void	Board_save_board(int board_type);
void	Board_load_board(int board_type);
void	Board_reset_board(int board_num);
void	Board_write_message(int board_type, struct char_data *ch, struct obj_data *obj, char *arg);
