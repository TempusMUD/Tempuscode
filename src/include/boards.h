...
#define NUM_OF_BOARDS	        55	/* change if needed! */
...
int Board_display_msg(int board_type, struct Creature *ch,
	struct obj_data *obj, char *arg);
int Board_show_board(int board_type, struct Creature *ch,
	struct obj_data *obj, char *arg);
int Board_remove_msg(int board_type, struct Creature *ch,
	struct obj_data *obj, char *arg);
