...
static const int PLR_NOCLANMAIL = (1 << 12);	/* Player doesn't get clanmail    */
...
static const int PLR_UNUSED6 = (1 << 26);
...
static const int PRF_NOPLUG = (1 << 11);	/* No repetition of comm commands    */
...
static const int AFF3_DETECT_POISON = (1 << 10);
