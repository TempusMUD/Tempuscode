...
static inline bool
NPC_FLAGGED(struct creature *ch, enum mob_flag flag)
{
    return IS_NPC(ch) && IS_SET(NPC_FLAGS(ch), flag);
}
static inline bool
NPC2_FLAGGED(struct creature *ch, enum mob2_flag flag)
{
    return IS_NPC(ch) && IS_SET(NPC2_FLAGS(ch), flag);
}
static inline bool
PLR_FLAGGED(struct creature *ch, enum plr_flag flag)
{
    return IS_PC(ch) && IS_SET(PLR_FLAGS(ch), flag);
}
static inline bool
PLR2_FLAGGED(struct creature *ch, enum plr2_flag flag)
{
    return IS_PC(ch) && IS_SET(PLR2_FLAGS(ch), flag);
}
static inline bool
AFF_FLAGGED(struct creature *ch, enum affect_bit flag)
{
    return IS_SET(AFF_FLAGS(ch), flag);
}
static inline bool
AFF2_FLAGGED(struct creature *ch, enum aff2_bit flag)
{
    return IS_SET(AFF2_FLAGS(ch), flag);
}
static inline bool
AFF3_FLAGGED(struct creature *ch, enum aff3_bit flag)
{
