...
//
// File: oldstructs.h                      -- Part of TempusMUD
//
...
#define ZONE_MOBS_APPROVED      (1 << 8)
#define ZONE_OBJS_APPROVED      (1 << 9)
#define ZONE_ROOMS_APPROVED     (1 << 10)
#define ZONE_ZCMDS_APPROVED     (1 << 11)
#define ZONE_MOBS_MODIFIED      (1 << 12)
#define ZONE_OBJS_MODIFIED      (1 << 13)
#define ZONE_ROOMS_MODIFIED     (1 << 14)
#define ZONE_ZONE_MODIFIED      (1 << 15)
...
#define NUM_LIQUID_TYPES 34

#define FIRST_CHEMICAL 100
#define LIQ_HEROIN     100
#define LIQ_BLUE_NINE  101
#define LIQ_ENDORPH_A  102
#define MAX_CHEMICAL   102
