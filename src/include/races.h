...
struct creatureRace {
    ...
    char
    getStrMod() { return _strMod; };
    char
    getIntMod() { return _intMod; };
    char
    getWisMod() { return _wisMod; };
    char
    getDexMod() { return _dexMod; };
    char
    getConMod() { return _conMod; };
    char
    getChaMod() { return _chaMod; };

    // Manipulators
    void
    setOwner(struct creature *owner) { _owner = owner; applyRacialSkills(); };
