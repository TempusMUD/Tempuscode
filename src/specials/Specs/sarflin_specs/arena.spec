...
SPECIAL(arena_object)
{
	...
	if (!strncasecmp(buf, "release", 7)) {
		...
		case 0:
			new_mob = read_mobile(30091);
			break;				/* mutant rat */
		case 1:
			new_mob = read_mobile(3360);
			break;				/* imp */
		case 2:
			new_mob = read_mobile(3364);
			break;				/* imp */
		case 3:
			new_mob = read_mobile(3365);
			break;				/* snake dog */
		case 4:
			new_mob = read_mobile(30094);
			break;				/* sand dragon */
		case 5:
			new_mob = read_mobile(3412);
			break;				/* skeleton */
		case 6:
			new_mob = read_mobile(3214);
			break;				/* saber tooth tiger */
		case 7:
			new_mob = read_mobile(3370);
			break;				/* sword swalower */
		case 8:
			new_mob = read_mobile(3215);
			break;				/* hydra */
		case 9:
			new_mob = read_mobile(9007);
			break;				/* ghoul */
		case 10:
			new_mob = read_mobile(20022);
			break;				/* ogre */
		case 11:
			new_mob = read_mobile(20022);
			break;
		case 12:
			...
			break;
		case 13:
			new_mob = read_mobile(3068);
			break;				/* green blob */
		case 14:
			new_mob = read_mobile(13413);
			break;				/* black mage */
		case 15:
			new_mob = read_mobile(13410);
			break;				/* bone golem */
		case 16:
			new_mob = read_mobile(3059);
			break;				/* holy defender */
		case 17:
			new_mob = read_mobile(5004);
			break;				/* sand worm */
		case 18:
			new_mob = read_mobile(20010);
			break;				/* hill giant */
		case 19:
			new_mob = read_mobile(13804);
			break;				/* shambling */
		case 20:
			new_mob = read_mobile(9901);
			break;				/* wight */
		case 21:
