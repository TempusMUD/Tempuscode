...
SPECIAL(puppet)
{
    ...
    if (!cmd && !is_fighting(me2) && !number(0, 3)) {
        ...
        case 0:
            ...
            break;
        case 1:
            act("The puppet says: That @^#%* wizard always makeing me touch my toes!", false, ch, NULL, me2, TO_ROOM);
            break;
        case 2:
            act("The puppet says: WOW, so this is what the world looks like!",
                false, ch, NULL, me2, TO_ROOM);
            break;
        case 3:
            act("The puppet says: You know I have always thought that you don't need to worry about the guy that ", false, ch, NULL, me2, TO_ROOM);
            act("pulls a sword from a stone. You need to worry about the guy that put it there! ", false, ch, NULL, me2, TO_ROOM);
            break;
        case 4:
            ...
            break;
        case 5:
            act("The puppet says: I know that pesky imp is around here some where.", false, ch, NULL, me2, TO_ROOM);
            break;
        case 6:
            act("The puppet says: HEY do you owe me gold?", false, ch, NULL, me2,
                TO_ROOM);
            break;
        case 7:
            ...
            break;
        case 8:
            act("The puppet says: You arn't so tough. I could kill you with ... UMMM one giant!", false, ch, NULL, me2, TO_ROOM);
            break;
        case 9:
