...
SPECIAL(duke_nukem)
{
    ...
    case 3:
    case 4:
        do_gen_comm(duke, tmp_strdup("Holy Shit!"), 0, SCMD_SPEW);
        break;
    case 5:
        do_gen_comm(duke, tmp_strdup("Hehehe.  What a mess."), 0, SCMD_GOSSIP);
        break;
    case 6:
        do_gen_comm(duke, tmp_strdup("Damn I'm good."), 0, SCMD_GOSSIP);
        break;
    case 7:
        do_gen_comm(duke,
    ...
    case 8:
        ...
        break;
    case 9:
        do_gen_comm(duke, tmp_strdup("Gonna rip 'em a new one."), 0, SCMD_SPEW);
        break;
    case 10:
        do_gen_comm(duke,
    ...
    case 13:
        ...
        break;
    case 14:
        do_gen_comm(duke, tmp_strdup("Ready for action."), 0, SCMD_SHOUT);
        break;
    case 15:
        perform_say(duke, "say", "Cool.");
        break;
    case 16:
        do_gen_comm(duke, tmp_strdup("Let God sort 'em out."), 0, SCMD_SPEW);
        break;
    case 17:
    case 18:
    case 19:
    ...
    case 21:
    case 22:
        do_gen_comm(duke, tmp_strdup("Who wants some?"), 0, SCMD_GOSSIP);
        break;
    case 23:
        do_gen_comm(duke,
            tmp_strdup
