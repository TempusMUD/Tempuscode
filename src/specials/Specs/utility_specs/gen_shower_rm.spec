...
SPECIAL(gen_shower_rm)
{
  ...
  send_to_char("You turn on the shower and step under the pouring water.\r\n", ch);
  act("$n turns on the shower and steps under the pouring water.", FALSE, ch, 0, 0, TO_ROOM);

  if (IS_WEARING_W(ch) || IS_CARRYING_W(ch)) {
    send_to_char("All your things get soaking wet!\r\n", ch);
    return 1;
  }
  send_to_char("The hot water runs over your naked body, refreshing you.\r\n", ch); 
