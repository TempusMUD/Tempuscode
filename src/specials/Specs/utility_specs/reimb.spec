...
SPECIAL(reimb)
{
  ...
  struct char_data *reimber = (struct char_data *) me;
  int i;
  typedef struct {
    int level;
    char *name;
...
{46, "Elric", "ElEAvJpYWb", 760146, 8840579, 18, 40, 18, 16, 18, 18, 8},
{14, "Jstraw", "Jsz.UWB/y/", 150315, 8840579, 16, 0, 13, 16, 16, 17, 10},
{16, "Halfstep", "HaPYbxley1", 113112, 8790579, 15, 0, 14, 17, 18, 14, 11},
{18, "Repeater", "Rebj8uWJsu", 833280, 8330579, 11, 0, 18, 18, 18, 17, 10},
{46, "Striker", "StWPcaWI7.", 0, 8840579, 18, 20, 19, 18, 16, 16, 18},
{43, "Doom", "DoJKjDNIe4", 92788, 8840579, 18, 100, 18, 18, 15, 16, 11},
{45, "Death", "De2y5nFmBc", 93988, 8840579, 18, 60, 16, 14, 17, 16, 12},
...
{18, "Rachael", "RaeytuRy/S", 205324, 8840579, 16, 0, 18, 14, 12, 13, 10},
{ 2, "Traxus", "TrMSYKGHhz", 332, 0, 17, 0, 10, 11, 15, 16, 5},
{39, "Wizard", "WiCfRNsNHQ", 105651, 8840579, 18, 0, 16, 18, 18, 17, 7},
{21, "Ironwolf", "IrnZqu2QRX", 147306, 8840579, 18, 87, 15, 16, 18, 16, 9},
{ 2, "Halo", "HajBjXyELW", 10069, 0, 12, 0, 17, 16, 12, 16, 9},
{49, "ClERic", "ClI3zYEZ/N", 9400, 8840579, 18, 50, 18, 18, 18, 17, 10},
...
{45, "Brian", "Br.Bl7j84M", 692725, 8840579, 18, 60, 18, 16, 18, 16, 11},
{ 4, "Mindcrime", "MiXyv9cf/a", 93949, 8840579, 18, 60, 14, 14, 14, 16, 6},
{ 7, "Desami", "DetZSWOFnw", 102365, 0, 18, 20, 17, 18, 16, 18, 17},
{37, "Jaberdawn", "Jaj6jT/Tet", 124811, 8740579, 17, 0, 11, 13, 14, 16, 6},
{12, "Conn", "CoauJ4c5LF", 93980, 8840579, 18, 30, 16, 16, 17, 18, 7},
{16, "Kalarr", "Ka4k93kfNh", 247186, 8840579, 12, 0, 18, 16, 18, 14, 12},
{41, "Canon", "CaeHtKIavU", 93988, 8840579, 18, 20, 18, 18, 18, 18, 9},
{40, "Rikus", "RirtdZ8nLS", 93705, 8840579, 18, 100, 17, 16, 17, 18, 1},
...
{19, "Pete", "Pe5vriHxXh", 100437, 8840579, 18, 20, 9, 8, 16, 16, 6},
    ...
    {40, "Raven", "RaD7h8spab", 360881, 9200000, 11, 0, 15, 16, 19, 17, 11},
    {35, "Dirk", "Dij4TyxDAu", 229875, 1000000, 12, 0, 18, 15, 19, 11, 13},
    {17, "Jason", "JaIcyB1Z27", 667330, 7375208, 18, 0, 13, 15, 19, 17, 9},
    {46, "Elric", "ElEAvJpYWb", 1666041, 32560600, 18, 40, 18, 16, 18, 18, 8},
    {40, "Canon", "CaeHtKIavU", 1000000, 8500492, 18, 20, 18, 18, 18, 18, 9},
    {47, "SPAWN", "SPTfNE5QY3", 1016862, 12250000, 18, 0, 14, 18, 18, 18, 9},
    ...
    {40, "Rikus", "RirtdZ8nLS", 537266, 9000000, 18, 100, 17, 16, 17, 18, 1},
...
{17, "Rachael", "RaeytuRy/S", 184010, 4700000, 16, 0, 18, 14, 12, 13, 10},
...
{45, "DarkAngel", "Datw0rHgsj", 2080689, 0, 18, 100, 18, 18, 19, 18, 8},
{35, "Shadow", "Sh7D2.Us7I", 77165220, 0, 18, 100, 18, 18, 19, 18, 11},
{47, "Stone", "St6icV8zA/", 131800, 9271614, 18, 95, 18, 18, 17, 15, 13},
{21, "Ironwolf", "IrnZqu2QRX", 239852, 9965404, 18, 87, 15, 16, 18, 16, 9},
{47, "Grim", "GrTKq93oLz", 3195205, 24500000, 18, 100, 11, 16, 17, 17, 6},
{39, "Wizard", "WiCfRNsNHQ", 5021740, 100000, 18, 0, 16, 18, 18, 17, 7},
{47, "MEDEVAC", "MEkCZE1eEd", 1522425, 13000000, 18, 40, 18, 18, 18, 18, 6},
{46, "Striker", "StWPcaWI7.", 981189, 29000000, 18, 20, 19, 18, 16, 16, 18},
{11, "Britnae", "BrCn/QbFvj", 46665, 500, 7, 0, 17, 15, 12, 9, 9},
{ 4, "Skogin", "SkhUbCvGXZ", 0, 0, 18, 40, 11, 16, 14, 18, 10},
{47, "Vengeance", "VefaM.WulX", 53622, 7500000, 18, 20, 12, 18, 19, 13, 11},
{11, "Mystra", "MyZ88u5ciu", 291911, 5450000, 11, 0, 15, 16, 16, 18, 12},
{49, "Djiin", "DjD7jedGvt", 0, 75000, 18, 20, 18, 18, 16, 18, 9},
{16, "Argon", "ArSAF9Fmo/", 184189, 9700000, 18, 20, 18, 18, 18, 16, 14},
{12, "Havoc", "Ha/ZRf1WOS", 180670, 150000, 18, 100, 14, 18, 18, 18, 11},
{ 4, "Logan", "LoDtvXxRHw", 100000000, 0, 18, 30, 16, 18, 18, 18, 13},
{18, "Demolition", "DePdQpLj5M", 9969330, 0, 18, 100, 18, 18, 18, 18, 9},
{45, "Rolent", "RoEKHygDHG", 0, 1700000, 17, 0, 11, 9, 18, 18, 8},
{40, "Turtle", "TuCGDYQe/V", 120858, 1325000, 13, 0, 19, 18, 15, 18, 14},
{42, "Keoria", "Ke4KUj8s2n", 128679, 6500000, 17, 0, 15, 11, 15, 18, 10},
...
{ 9, "SMILEY", "SM9Jm3SYaC", 1985562, 312791, 18, 70, 13, 13, 18, 18, 10},
{26, "Convict", "CoohMKJNQF", 10000678, 0, 18, 10, 16, 16, 19, 17, 9},
{44, "Gossamer", "Goi3AzLh.J", 1553409, 5000000, 18, 20, 13, 15, 18, 14, 10},
...
{23, "Gabriel", "Gaey7CRxPF", 700240, 1360000, 18, 20, 12, 14, 19, 18, 8},
...
{45, "Brian", "Br.Bl7j84M", 138544, 4500000, 18, 60, 18, 16, 18, 16, 11},
...
{10, "Prometheus", "Pr3zY.5e10", 119350, 180000, 18, 0, 14, 14, 12, 16, 4},
{22, "Seren", "Se/wna04mZ", 208453, 0, 18, 0, 16, 16, 15, 16, 13},
{12, "Conn", "CoauJ4c5LF", 217105, 21000000, 18, 30, 16, 16, 17, 18, 7},
...
{37, "Jaberdawn", "Jaj6jT/Tet", 50169, 100000, 17, 0, 11, 13, 14, 16, 6},
{ 7, "Ping", "PiD1l8bhPg", 193280, 0, 13, 0, 16, 18, 12, 12, 5},
{13, "Repeater", "Rebj8uWJsu", 26456, 776194, 11, 0, 18, 18, 18, 17, 10},
...
{11, "Kalarr", "Ka4k93kfNh", 638179, 24900000, 12, 0, 18, 16, 18, 14, 12},
{33, "BlackDeath", "BlDbTZPJmI", 9925165, 0, 18, 100, 18, 18, 18, 18, 5},
...
{12, "Halfstep", "HaPYbxley1", 17098, 55000, 15, 0, 14, 17, 18, 14, 11},
    ...
    if (!strncasecmp(data[i].name, GET_NAME(ch), strlen(data[i].name))) {
      if (GET_LEVEL(ch) >= data[i].level)
        ...
        if (!(data[i].level > 49 || data[i].level < 1))
          gain_exp_regardless(ch, titles[(int)GET_CLASS(ch)][data[i].level].exp
                             - GET_EXP(ch));
        save_char(ch, NULL);
