...
SPECIAL(quasimodo)
{
	...
	case 0:
		...
		do_say(ch, "Bienvenue, je m'appelle Quasimodo.", 0, 0, 0);
		break;
	case 1:
		act("$n goes about his bell-ringing duties.", FALSE, ch, 0, 0,
			TO_ROOM);
		do_say(ch, "Cannot be late ringing the bells.", 0, 0, 0);
		break;
	case 2:
	...
	case 4:
		act("$n grips the bell rope tightly and says a prayer.", FALSE,
			ch, 0, 0, TO_ROOM);
		do_say(ch, "May the next hour bring us hope.", 0, 0, 0);
		break;
	case 5:
		do_say(ch, "You better leave now, the bells are sacred.", 0, 0, 0);
