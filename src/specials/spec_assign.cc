...
const struct spec_func_data spec_list[] = {
    ...
    {"guildguard",      guild_guard,           SPEC_MOB},
    ...
    {"thieves_guard_south", thieves_guard_south, SPEC_MOB | SPEC_RES},
    {"thieves_guard_west", thieves_guard_west, SPEC_MOB | SPEC_RES},
    ...
    {"DicknDavid",      DicknDavid,            SPEC_MOB | SPEC_RES},
    ...
    {"hobbes_speaker",  hobbes_speaker,        SPEC_MOB},
    ...
    {"morkoth",         morkoth,               SPEC_MOB | SPEC_RES },
    ...
    {"physic_guildguard", physic_guildguard,   SPEC_RM | SPEC_RES},
...
const char *spec_flags[] =
{ "MOB", "OBJ", "ROOM", "RESERVED"};
