...
struct command_info cmd_info[] = {
    ...
    {"alterations", POS_DEAD, do_skills, 0, SCMD_ALTERS_ONLY, 0, 0},
    ...
    {"dilute", POS_RESTING, do_dilute, 0, 0, 0, 0},
    ...
    {"distill", POS_RESTING, do_distill, 0, 0, 0, 0},
    ...
    {"hp", POS_DEAD, do_gen_points, 0, SCMD_HITPOINTS, 0, 0},
    ...
    {"programs", POS_DEAD, do_skills, 0, SCMD_PROGRAMS_ONLY, 0, 0},
    ...
    {"recall", POS_DEAD, do_return, 0, SCMD_RETURN, 0, 0},
    ...
    {"skills", POS_DEAD, do_skills, 0, SCMD_SKILLS_ONLY, 0, 0},
    ...
    {"songs", POS_DEAD, do_skills, 0, SCMD_SONGS_ONLY, 0, 0},
    ...
    {"spells", POS_DEAD, do_skills, 0, SCMD_SPELLS_ONLY, 0, 0},
    ...
    {"transmute", POS_SLEEPING, do_transmute, 0, 0, 0, 0},
    ...
    {"triggers", POS_DEAD, do_skills, 0, SCMD_TRIGGERS_ONLY, 0, 0},
    ...
    {"worth", POS_DEAD, do_gold, 0, 0, 0, 0},
    ...
    {"zens", POS_DEAD, do_skills, 0, SCMD_ZENS_ONLY, 0, 0},
