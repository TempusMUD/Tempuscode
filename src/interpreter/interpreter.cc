...
struct command_info cmd_info[] = {
	...
	{"addname", POS_SLEEPING, do_addname, LVL_IMMORT, 0, 0},
	{"addpos", POS_SLEEPING, do_addpos, LVL_IMMORT, 0, 0},
	{"advance", POS_DEAD, do_advance, LVL_IMMORT, 0, 0},
...
//	{"ambush", POS_STANDING, do_ambush, 0, 0, 0},
	...
	{"approve", POS_DEAD, do_approve, LVL_IMMORT, 0, 0},
	{"unapprove", POS_DEAD, do_unapprove, LVL_IMMORT, 0, 0},
	...
	{"ban", POS_DEAD, do_ban, LVL_IMMORT, 0, 0},
	...
	{"clansay", POS_MORTALLYW, do_gen_comm, LVL_CAN_CLAN, SCMD_CLANSAY, 0},
	...
	{"council", POS_DEAD, do_wizutil, LVL_IMMORT, SCMD_COUNCIL, 0},
	...
	{"dynedit", POS_DEAD, do_dynedit, LVL_IMMORT, 0, 0},
	...
	{"force", POS_SLEEPING, do_force, LVL_IMMORT, 0, 0},
	...
	{"freeze", POS_DEAD, do_wizutil, LVL_IMMORT, SCMD_FREEZE, 0},
	...
	{"gecho", POS_DEAD, do_gecho, LVL_IMMORT, 0, 0},
	...
	{"grunt", POS_RESTING, do_action, 0, 0, 0},
	...
	{"guildsay", POS_MORTALLYW, do_gen_comm, 0, SCMD_GUILDSAY, 0},
	{"guilddonate", POS_RESTING, do_drop, 0, SCMD_GUILD_DONATE, 0},
	...
	{"hcontrol", POS_DEAD, do_hcontrol, LVL_IMMORT, 0, 0},
	...
	{"mload", POS_SLEEPING, do_mload, LVL_IMMORT, 0, 0},
	...
	{"nolocate", POS_SLEEPING, do_nolocate, LVL_IMMORT, 0, 0},
	...
	{"notitle", POS_DEAD, do_wizutil, LVL_IMMORT, SCMD_NOTITLE, 0},
	{"nopost", POS_DEAD, do_wizutil, LVL_IMMORT, SCMD_NOPOST, 0},
	...
	{"oload", POS_SLEEPING, do_oload, LVL_IMMORT, 0, 0},
	{"offer", POS_STANDING, do_not_here, 1, 0, 0},
	{"open", POS_SITTING, do_gen_door, 0, SCMD_OPEN, 0},
	{"oecho", POS_DEAD, do_oecho, LVL_IMMORT, 0, 0},
	{"oset", POS_DEAD, do_oset, LVL_IMMORT, 0, 0},
	...
	{"page", POS_DEAD, do_page, LVL_IMMORT, 0, 0},
	{"pardon", POS_DEAD, do_wizutil, LVL_IMMORT, SCMD_PARDON, 0},
	{"park", POS_SITTING, do_action, 0, 0, 0},
	{"passout", POS_RESTING, do_action, 0, 0, 0},
	{"peace", POS_SLEEPING, do_peace, LVL_IMMORT, 0, 0},
	...
	{"pload", POS_RESTING, do_pload, LVL_IMMORT, 0, 0},
	...
	{"purge", POS_DEAD, do_purge, LVL_IMMORT, 0, 0},
	...
	{"qpreload", POS_DEAD, do_qpreload, LVL_IMMORT, 0, 0},
	...
	{"reload", POS_DEAD, do_reboot, LVL_IMMORT, 0, 0},
	...
	{"rename", POS_SLEEPING, do_rename, LVL_IMMORT, 0, 0},
	{"rent", POS_STANDING, do_not_here, 1, 0, 0},
	{"report", POS_SLEEPING, do_report, 0, 0, 0},
	{"reroll", POS_DEAD, do_wizutil, LVL_IMMORT, SCMD_REROLL, 0},
	{"rescue", POS_FIGHTING, do_rescue, 1, 0, 0},
	{"restore", POS_DEAD, do_restore, LVL_IMMORT, 0, 0},
	...
	{"rswitch", POS_DEAD, do_rswitch, LVL_IMMORT, 0, 0},
	...
	{"skset", POS_SLEEPING, do_skillset, LVL_IMMORT, 0, 0},
	{"skillset", POS_SLEEPING, do_skillset, LVL_IMMORT, 0, 0},
	...
	{"snoop", POS_DEAD, do_snoop, LVL_IMMORT, 0, 0},
	...
	{"switch", POS_DEAD, do_switch, LVL_IMMORT, 0, 0},
	...
	{"teleport", POS_DEAD, do_teleport, LVL_IMMORT, 0, 0},
	{"thank", POS_RESTING, do_action, 0, 0, 0},
	{"think", POS_RESTING, do_action, 0, 0, 0},
	{"thaw", POS_DEAD, do_wizutil, LVL_IMMORT, SCMD_THAW, 0},
	...
	{"unban", POS_DEAD, do_unban, LVL_IMMORT, 0, 0},
	{"unaffect", POS_DEAD, do_wizutil, LVL_IMMORT, SCMD_UNAFFECT, 0},
	{"undisguise", POS_RESTING, do_disguise, 0, 1, 0},
	{"undress", POS_RESTING, do_action, 0, 0, 0},
	{"uninstall", POS_DEAD, do_uninstall, LVL_IMMORT, 0, 0},
	...
	{"wiznet", POS_DEAD, do_wiznet, LVL_IMMORT, SCMD_WIZNET, 0},
	...
	{"xlag", POS_DEAD, do_xlag, LVL_IMMORT, 0, 0},
	...
	{"zreset", POS_DEAD, do_zreset, LVL_IMMORT, 0, 0},
	...
	{"calmly", POS_DEAD, do_mood, 0, 0, 0},
	{"carefully", POS_DEAD, do_mood, 0, 0, 0},
	{"cautiously", POS_DEAD, do_mood, 0, 0, 0},
	{"contentedly", POS_DEAD, do_mood, 0, 0, 0},
	{"crazily", POS_DEAD, do_mood, 0, 0, 0},
	{"curiously", POS_DEAD, do_mood, 0, 0, 0},
	{"desperately", POS_DEAD, do_mood, 0, 0, 0},
	{"divinely", POS_DEAD, do_mood, LVL_IMMORT, 0, 0},
	{"dreamily", POS_DEAD, do_mood, 0, 0, 0},
	{"evilly", POS_DEAD, do_mood, 0, 0, 0},
	{"fearfully", POS_DEAD, do_mood, 0, 0, 0},
	{"fiercely", POS_DEAD, do_mood, 0, 0, 0},
	{"fondly", POS_DEAD, do_mood, 0, 0, 0},
	{"gallantly", POS_DEAD, do_mood, 0, 0, 0},
	{"gently", POS_DEAD, do_mood, 0, 0, 0},
	{"graciously", POS_DEAD, do_mood, 0, 0, 0},
	{"happily", POS_DEAD, do_mood, 0, 0, 0},
	{"hatefully", POS_DEAD, do_mood, 0, 0, 0},
	{"icily", POS_DEAD, do_mood, 0, 0, 0},
	{"impatiently", POS_DEAD, do_mood, 0, 0, 0},
	{"innocently", POS_DEAD, do_mood, 0, 0, 0},
	{"kindly", POS_DEAD, do_mood, 0, 0, 0},
	{"knowingly", POS_DEAD, do_mood, 0, 0, 0},
	{"lazily", POS_DEAD, do_mood, 0, 0, 0},
	{"loudly", POS_DEAD, do_mood, 0, 0, 0},
	{"lovingly", POS_DEAD, do_mood, 0, 0, 0},
	{"lustily", POS_DEAD, do_mood, 0, 0, 0},
	{"merrily", POS_DEAD, do_mood, 0, 0, 0},
	{"nervously", POS_DEAD, do_mood, 0, 0, 0},
	...
	{"ruthlessly", POS_DEAD, do_mood, 0, 0, 0},
	{"sadly", POS_DEAD, do_mood, 0, 0, 0},
	{"savagely", POS_DEAD, do_mood, 0, 0, 0},
	{"sheepishly", POS_DEAD, do_mood, 0, 0, 0},
	{"shyly", POS_DEAD, do_mood, 0, 0, 0},
	{"skeptically", POS_DEAD, do_mood, 0, 0, 0},
	{"slowly", POS_DEAD, do_mood, 0, 0, 0},
	{"slyly", POS_DEAD, do_mood, 0, 0, 0},
	{"softly", POS_DEAD, do_mood, 0, 0, 0},
	{"solemnly", POS_DEAD, do_mood, 0, 0, 0},
	{"sweetly", POS_DEAD, do_mood, 0, 0, 0},
	{"viciously", POS_DEAD, do_mood, 0, 0, 0},
	{"warily", POS_DEAD, do_mood, 0, 0, 0},
	{"warmly", POS_DEAD, do_mood, 0, 0, 0},
	{"wearily", POS_DEAD, do_mood, 0, 0, 0},
	{"wildly", POS_DEAD, do_mood, 0, 0, 0},
	{"wisely", POS_DEAD, do_mood, 0, 0, 0},
	{"valiantly", POS_DEAD, do_mood, 0, 0, 0},
	{"\n", 0, 0, 0, 0, 0}
};								/* this must be last */
