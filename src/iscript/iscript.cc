...
CHandler *CIScript::handler_exists(const string &event_type)
{
...
void CIScript::do_handler(CHandler *theHandler)
{
    if(theHandler != NULL) {    
...
void CHandler::process_handler(CHandler *theHandler)
{
    list<string>::iterator l;
    char buf[MAX_INPUT_LENGTH];
    
    for(l = theHandler->theLines.begin(); l != theHandler->theLines.end(); l++) {
...
void CIScript::setTarget(char_data *target)
{
    this->target = target;
}

void CIScript::setInit(char_data *init)
{
    this->ch = init;
}

void CHandler::setTarget(char_data *target)
{
    this->target = target;
}

void CHandler::setInit(char_data *init)
{
    this->ch = init;
}

string CHandler::getEventType()
{
...
string CIScript::getName()
{
    return this->name;
}

void CIScript::setName(string name)
{
    this->name = name;
}

int CIScript::getVnum()
{
    return this->vnum;
}

void CIScript::setVnum(int vnum)
{
    this->vnum = vnum;
}

bool CIScript::deleteHandler(string event_type)
{
