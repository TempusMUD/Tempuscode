(Message inbox:2886)
Return-Path: Bart.Lauwers@rug.ac.be
Return-Path: <Bart.Lauwers@rug.ac.be>
Received: from mserv.rug.ac.be
           by blaze.cs.jhu.edu; Sun, 5 Mar 95 18:31:47 EST
Sender: Bart.Lauwers@rug.ac.be
Received: from eduserv.rug.ac.be by mserv.rug.ac.be with SMTP id AA21497
  (5.67b/IDA-1.5 for <jelson@blaze.cs.jhu.edu>); Mon, 6 Mar 1995 00:30:47 +0100
Received: by eduserv.rug.ac.be (5.x/SMI-SVR4)
	id AA10705; Mon, 6 Mar 1995 00:30:30 +0100
Date: Mon, 6 Mar 1995 00:30:30 +0100 (MET)
From: Bart Lauwers <Bart.Lauwers@rug.ac.be>
To: Elson Jeremy <jelson@blaze.cs.jhu.edu>
Subject: autowiz again, I am so dumb...
Message-Id: <Pine.SOL.3.91.950306002928.10689A-100000@eduserv.rug.ac.be>
Mime-Version: 1.0
Content-Type: TEXT/PLAIN; charset=US-ASCII

Hi well here it is again... sorry I sent the wrong one... have fun!
